...
function OfferPage(): React.ReactElement {
  ...
  ); // ✅ Используем FullOffer[]

  if (!offer) {
    return <ErrorPage />; // Если предложения нет, показываем страницу 404
  }

  // Фильтрация предложений неподалеку (из того же города)
        ...
        <section className="offer">
          <div className="offer__gallery-container container">
            <div className="offer__gallery">
              {offer.images.length > 0 ? ( // ✅ Проверяем, есть ли изображения
                ...
                <p>No images available</p> // ✅ Если нет изображений, показываем текст
              )}
            </div>
          </div>
